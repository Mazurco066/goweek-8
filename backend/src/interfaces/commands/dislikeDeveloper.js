...
module.exports = (developerRepository) => ({
    ...
    // Matching developers
    unmatchDeveloper: async function(data) {
        ...
        if (!currentDev || !targetDev) {
            ...
            if (currentDev.dislikes.includes(targetDev.id)) {
                return baseResponse(400, 'you already disliked this Developer', data)
            }
            const updatedUser = developer.update(currentDev, {
                dislikes: [ ...currentDev.dislikes, targetDev.id ]
            })
